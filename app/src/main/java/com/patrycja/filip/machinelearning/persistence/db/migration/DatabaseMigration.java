...
public interface DatabaseMigration {
    ...
    Migration MIGRATION_2_3 = new Migration(2, 3) {
        ...
        public void migrate(SupportSQLiteDatabase database) {
            ...
            database.execSQL("Insert into chapters (title, is_unlocked, earned_exp, percentage_progress) values ('Process 3', '0', '0', '0')");
            database.execSQL("Insert into chapters (title, is_unlocked, earned_exp, percentage_progress) values ('Problems 4', '0', '0', '0')");
